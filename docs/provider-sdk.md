...
Provider punctuation is converted to `_` for environment-variable names. Built-in providers keep their established environment names, including `PAYLAB_STRIPE_WEBHOOK_SECRET` for Stripe.
